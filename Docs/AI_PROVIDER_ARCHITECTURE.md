...
User Conversation AI: reminder, history search, assistant profile/onboarding, instance Web Research, Storage read/search/chat files. Не Gmail/Calendar/GitHub/groups/projects. `delete_storage_file` and Storage page are owner-only.
