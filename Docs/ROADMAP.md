...
- Owner Web Workspace (`/jarvis`, M22 implemented / not validated; M22.1 images + artifacts; M22.2 Storage + ephemeral screenshots; M22.3 Web Research + Context Budget Manager implemented / not validated)
