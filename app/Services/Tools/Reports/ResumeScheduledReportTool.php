...
final class ResumeScheduledReportTool implements JarvisTool
{
    public const NAME = 'resume_scheduled_report';
    ...
    public function definition(): ToolDefinition
    {
        return new ToolDefinition(
            name: self::NAME,
            description: 'Resumes a paused owned scheduled report.',
            parameters: [
                'type' => 'OBJECT',
                'properties' => [
    ...
    public function execute(ToolCall $call, ToolExecutionContext $context): ToolResult
    {
        ...
        try {
            $report = $this->reports->resumeOwned($context->user, (int) $resolved['report']->id);
