...
final class CompleteReminderTool implements JarvisTool
{
    public const NAME = 'complete_reminder';
    ...
    public function execute(ToolCall $call, ToolExecutionContext $context): ToolResult
    {
        ...
        try {
            $reminder = $this->reminders->completeOwned($context->user, (int) $picked['reminder']->id);
