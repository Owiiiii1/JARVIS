...
final class PauseWatcherTool implements JarvisTool
{
    public const NAME = 'pause_watcher';
    ...
    public function definition(): ToolDefinition
    {
        return new ToolDefinition(
            name: self::NAME,
            description: 'Pauses an owned watcher. It will not evaluate until resumed.',
            parameters: [
                'type' => 'OBJECT',
                'properties' => [
    ...
    {
        try {
            $watcher = $this->watchers->pauseOwned($context->user, (int) ($call->arguments['watcher_id'] ?? 0));
