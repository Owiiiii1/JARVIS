...
final class ResumeWatcherTool implements JarvisTool
{
    public const NAME = 'resume_watcher';
    ...
    public function definition(): ToolDefinition
    {
        return new ToolDefinition(
            name: self::NAME,
            description: 'Resumes a paused owned watcher.',
            parameters: [
                'type' => 'OBJECT',
                'properties' => [
    ...
    {
        try {
            $watcher = $this->watchers->resumeOwned($context->user, (int) ($call->arguments['watcher_id'] ?? 0));
