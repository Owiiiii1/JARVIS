...
final class CancelTaskTool implements JarvisTool
{
    public const NAME = 'cancel_task';
    ...
    public function definition(): ToolDefinition
    {
        return new ToolDefinition(
            name: self::NAME,
            description: 'Cancels an owned task that is no longer needed. Distinct from complete_task. Future linked reminders are cancelled; history remains.',
            parameters: [
                'type' => 'OBJECT',
                'properties' => [
    ...
    public function execute(ToolCall $call, ToolExecutionContext $context): ToolResult
    {
        ...
        try {
            $task = $this->tasks->cancelOwned($context->user, (int) $resolved['task']->id);
