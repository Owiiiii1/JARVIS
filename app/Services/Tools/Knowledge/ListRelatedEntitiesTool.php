...
final class ListRelatedEntitiesTool implements JarvisTool
{
    public const NAME = 'list_related_entities';
    ...
    public function definition(): ToolDefinition
    {
        return new ToolDefinition(
            name: self::NAME,
            description: 'Lists compact entities related to one knowledge entity owned by the current user (people on a project, systems a project uses, etc.).',
            parameters: [
                'type' => 'OBJECT',
                'properties' => [
                    'entity_id' => [
