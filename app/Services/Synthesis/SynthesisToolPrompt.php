...
final class SynthesisToolPrompt
{
    ...
    public static function lines(): array
    {
        return [
            ...
            'list_waiting_for / list_commitments (mine|others|all) are explicit loops only — not every open task. Vague language is not a commitment.',
            'get_person_status uses the current user’s Knowledge person entity only. Foreign ids fail.',
